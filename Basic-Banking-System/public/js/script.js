            ...
            $scope.amount=0;
            $scope.list = function () {
                var url = 'http://localhost:2804/getUsers';
            ...
            $scope.Transfer = function (TrFrom, TrTo, amount) {
                ...
                var inserturl = 'http://localhost:2804/insertUser';
                var updateUrl = 'http://localhost:2804/updateUser';
                $scope.amount = 0;
            ...
            $scope.listHistory = function () {
                var url = 'http://localhost:2804/getHistory';
